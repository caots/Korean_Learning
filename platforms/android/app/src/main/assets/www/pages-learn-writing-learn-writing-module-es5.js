(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-learn-writing-learn-writing-module"], {
    ...
    function srcAppPagesLearnWritingLearnWritingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _learn_writing_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./learn-writing.page */
      "./src/app/pages/learn-writing/learn-writing.page.ts");
    ...
    function srcAppPagesLearnWritingWritingHiraWritingPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_commom_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../../services/commom.service */
      "./src/app/services/commom.service.ts");
      /* harmony import */


      var _constants_api_config__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../../constants/api.config */
      "./src/app/constants/api.config.ts");
      /* harmony import */


      var tesseract_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! tesseract.js */
      "./node_modules/tesseract.js/src/index.js");
      /* harmony import */


      var tesseract_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(tesseract_js__WEBPACK_IMPORTED_MODULE_7__);

      var HiraWritingPage = /*#__PURE__*/function () {
        function HiraWritingPage(platform, activateRouter, router, commomService, wordService) {
        ...
        _createClass(HiraWritingPage, [{
          ...
          key: "saveCanvasImage",
          value: function saveCanvasImage() {
            var _this3 = this;
            ...
            var blob = this.commomService.b64toBlob(data, 'image/png');
            var imageWord = this.commomService.blobToFile(blob, 'image.png');
            this.commomService.uploadImageToServer(imageWord).subscribe(function (data) {
              _this3.fileImageWord = _constants_api_config__WEBPACK_IMPORTED_MODULE_6__["apiEndPointAws"].images + data.filename;

              _this3.recognizeImage(_this3.fileImageWord);
            }, function (err) {
              console.log(err);
            });
          }
          ...
          key: "recognizeImage",
          value: function recognizeImage(url) {
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      console.log(url);
                      _context4.next = 3;
                      return this.worker.recognize(this.image);
      ...
      var WordService = /*#__PURE__*/function () {
        ...
        _createClass(WordService, [{
          ...
          value: function getAllContact() {
            var url = "".concat(_constants_api_config__WEBPACK_IMPORTED_MODULE_2__["apiEndPoints"].word);
