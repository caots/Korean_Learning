...
TopicCardComponent.propDecorators = {
    topic: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['topic',] }]
};
...
/* harmony import */ var angular_progress_bar__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! angular-progress-bar */ "./node_modules/angular-progress-bar/__ivy_ngcc__/fesm2015/angular-progress-bar.js");
...
/* harmony import */ var _components_skeleton_skeleton_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../components/skeleton/skeleton.module */ "./src/app/components/skeleton/skeleton.module.ts");
/* harmony import */ var _components_topic_card_topic_card_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./../../components/topic-card/topic-card.module */ "./src/app/components/topic-card/topic-card.module.ts");
...
HomePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _components_skeleton_skeleton_module__WEBPACK_IMPORTED_MODULE_7__["SkeletonModule"],
            _components_topic_card_topic_card_module__WEBPACK_IMPORTED_MODULE_8__["TopicCardModule"],
            angular_progress_bar__WEBPACK_IMPORTED_MODULE_5__["ProgressBarModule"]
        ],
...
/* harmony import */ var _services_commom_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/commom.service */ "./src/app/services/commom.service.ts");
/* harmony import */ var _constants_api_config__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../constants/api.config */ "./src/app/constants/api.config.ts");
/* harmony import */ var _assets_images_abc_png__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./../../../assets/images/abc.png */ "./src/assets/images/abc.png");
...
let HomePage = class HomePage {
    constructor(camera, crop, file, commomService, actionSheetController) {
        this.camera = camera;
        this.crop = crop;
        this.file = file;
    ...
    showCroppedImage(ImagePath) {
        ...
        this.file.readAsDataURL(filePath, imageName).then(base64 => {
            ...
            this.commomService.uploadImageToServer(file).subscribe(data => {
                this.fileImageWord = _constants_api_config__WEBPACK_IMPORTED_MODULE_8__["apiEndPointAws"].images + data.filename;
            }, err => {
                console.log(err);
            });
        }, error => {
    ...
    recognizeImage() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const data = yield this.worker.recognize(this.fileImageWord);
            yield data.data.lines.map(line => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "abc.png");
